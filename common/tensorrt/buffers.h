 ...
 *
 * File: DL4AGX/common/tensorrt/buffers.h
 * Description: TensorRT Generic Buffer Implementation
 *************************************************************************/
#pragma once
#include "NvInfer.h"
...
public:
    ...
    {
        return this->size() * common::tensorrt::getElementSize(mType);
    }
    ...
    {
        return this->resize(common::tensorrt::volume(dims));
    }
...
public:
        ...
        , mBatchSize(batchSize)
    {
        ...
        for (int i = 0; i < mEngine->getNbBindings(); i++)
        {
            ...
            vol *= common::tensorrt::volume(dims);
