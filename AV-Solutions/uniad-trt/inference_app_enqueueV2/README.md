# C++ Inference Application with TensorRT::enqueueV2

## Environment
The inference application is tested on NVIDIA DRIVE Orin platform and X86 platform with `TensorRT 8.6`.
## Dependencies
