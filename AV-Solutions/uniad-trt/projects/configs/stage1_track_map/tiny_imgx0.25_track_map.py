...
# Modified from https://github.com/OpenDriveLab/UniAD/blob/main/projects/configs/stage1_track_map/base_track_map.py
# Added training stage1 config support for UniAD-tiny model
...
load_from = "ckpts/bevformer_tiny_epoch_24_updated2.pth"
