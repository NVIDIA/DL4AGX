...
#ifdef USE_PTX
#include "../dcnv4PtxPlugin/dcnv4_ptx.h"
#endif
...
class DCNv4_Plugin: public IPluginV2IOExt {
public:
    DCNv4_Plugin() noexcept {};
    DCNv4_Plugin(PluginFieldCollection const& fc) noexcept;
    DCNv4_Plugin(const std::string name, const void* serialData, size_t serialLength); 

    ~DCNv4_Plugin() override = default;
    ...
    const std::string mName = "DCNv4_Plugin"; 
...
class DCNv4_PluginChecker : public nvinfer1::consistency::IPluginChecker {
public:
    DCNv4_PluginChecker();
    ~DCNv4_PluginChecker() override = default;
...
}; // class DCNv4_PluginChecker

REGISTER_TENSORRT_PLUGIN(DCNv4_PluginChecker);
